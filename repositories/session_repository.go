...
type SessionRepository interface {
	StoreUserSession(ctx context.Context, token string, user *models.User, duration time.Duration) error
	GetUserSession(ctx context.Context, token string) (*models.User, error)
...
func (r *sessionRepository) StoreUserSession(ctx context.Context, token string, user *models.User, duration time.Duration) error {
...
func (r *sessionRepository) GetUserSession(ctx context.Context, token string) (*models.User, error) {
