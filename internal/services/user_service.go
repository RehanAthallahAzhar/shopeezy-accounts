...
import (
	...
	pkgErrors "github.com/RehanAthallahAzhar/shopeezy-accounts/internal/pkg/errors"
...
type UserService interface {
	...
	UpdateUser(ctx context.Context, id uuid.UUID, userReq *models.UserUpdateRequest) (*models.UserResponse, error)
...
func (s *UserServiceImpl) UpdateUser(ctx context.Context, id uuid.UUID, userReq *models.UserUpdateRequest) (*models.UserResponse, error) {
...
func mapToUserResponse(user *entities.User) *models.UserResponse {
